...
const Hero = () => {
  return (
    <section className="relative w-full min-h-screen bg-brand-gradient text-white flex items-center overflow-hidden pt-20 pb-12">
      ...
      <div className="section-shell flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12 lg:gap-16 px-4 sm:px-6 lg:px-8 w-full relative z-10 max-w-7xl mx-auto">
        {/* RIGHT IMAGE - Smaller and cuter */}
        <div className="flex-1 flex justify-center items-center relative w-full order-1 md:order-2">
          <div className="relative w-full max-w-[240px] sm:max-w-[280px] md:max-w-[320px] lg:max-w-[380px] py-10 sm:py-12">
            {/* Main Image - Compact and cute */}
            <div className="w-full relative group">
              {/* Subtle glow effect */}
              <div className="absolute inset-0 bg-gradient-to-r from-brand-accent/30 via-yellow-400/30 to-pink-400/30 blur-2xl opacity-50 group-hover:opacity-70 transition-opacity duration-500"></div>

              <img
                src="/images/card.png"
                alt="Smart Card Mockup"
                className="w-full h-auto drop-shadow-2xl relative z-10 transform group-hover:scale-105 transition-transform duration-300"
              />
            </div>

            {/* Floating Stats Cards - More separated and fully visible */}
