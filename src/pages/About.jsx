    ...
    <div className=" bg-white text-brand-dark ">
      <section className="section-shell pt-28 pb-10 border-b border-gray-200/60 ">
        ...
        >
          ...
          <div className="space-y-5 max-w-3xl" data-aos="fade-right">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 pt-2">
              ...
              <div className="card-glass px-4 py-3">
                ...
                <p className="text-sm font-medium">In One Link</p>
              </div>
            </div>
          </div>
          ...
          <div
            ...
            data-aos-delay="200"
          >
            <div className="absolute -inset-2 sm:-inset-4 bg-brand-primary/10 blur-2xl rounded-3xl pointer-events-none" />
      ...
      <section className="section-shell py-16 md:py-20">
        ...
        >
          ...
          <div className="grid gap-5 md:gap-6">
            <div
              className="rounded-2xl border border-gray-200 p-5 md:p-6 flex gap-4 hover:border-brand-primary/30 hover:shadow-md transition-all duration-300"
              data-aos="fade-left"
              data-aos-delay="200"
            >
              <div className="h-12 w-12 flex-shrink-0 flex items-center justify-center rounded-xl bg-brand-primary/10 text-brand-primary">
                <Smartphone size={24} />
              </div>
              <div>
            ...
            <div
              className="rounded-2xl border border-gray-200 p-5 md:p-6 flex gap-4 hover:border-brand-accent/30 hover:shadow-md transition-all duration-300"
              data-aos="fade-left"
              data-aos-delay="300"
            >
              <div className="h-12 w-12 flex-shrink-0 flex items-center justify-center rounded-xl bg-brand-accent/10 text-brand-accent">
                <Users size={24} />
              </div>
              <div>
                <p className="text-base md:text-lg font-semibold">
      ...
      <section className="section-shell py-16 md:py-20">
        <div className="max-w-2xl mb-10 md:mb-12" data-aos="fade-up">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold leading-tight">
            More than a card — a{" "}
            <span className="text-brand-primary">full identity</span>{" "}
        ...
        <div
          ...
          data-aos-delay="200"
        >
          <div className="rounded-2xl border border-gray-200 bg-white p-6 hover:border-brand-primary/30 hover:shadow-lg transition-all duration-300">
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-6 hover:border-brand-accent/30 hover:shadow-lg transition-all duration-300">
